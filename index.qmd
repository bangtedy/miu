...
- If, following Fischer (1979), the utility function takes the form
...
- Lucas (2000) provided estimates of the welfare costs of inflation, starting with the following specification of the instantaneous utility function: 
